...
from Arkleap.celery import app
...
class Export_Employee_allocation_percentages(Task):
    ...
    def create_report(self,data):
        ...
        paginator = Paginator(data, 65535)
    ...
    def run(self):
        data= Allocation.objects.all()

        download_url = self.create_report(data)
        mail_content = _(
            f"You can download "
...
Export_Employee_allocation_percentages=app.register_task(Export_Employee_allocation_percentages())
Notify_managers_total_allocation_percentage=app.register_task(Notify_managers_total_allocation_percentage())
Notify_managers_project_capacity_exceeded=app.register_task(Notify_managers_project_capacity_exceeded())